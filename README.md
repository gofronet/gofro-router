...
Здесь описан следующий подписанный кандидат VPN-only интеграции `0.5.17`.
Установленный подписанный кандидат v0.5.16 остаётся неизменяемой закреплённой
...
В кандидате v0.5.17 откройте `wifi.gofro.net` без порта из LAN — это панель
...
сохранены. Новый LAN IP, настройки сети, proxy, listener или зависимость не нужны.
